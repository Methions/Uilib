...
Connect(OpenButton.MouseButton1Click, function()
	...
	Connect(CancelBtn.MouseButton1Click, function()
		...
		Tween(ConfirmFrame, 0.25, { Size = UDim2.new(0, 374, 0, 187) })
		Tween(ConfirmDialog, 0.25, { GroupTransparency = 1 })
		task.wait(0.25)
		...
		if Button:IsA("TextButton") then
			...
			Connect(Button.MouseButton1Click, function() 
				if Name == "Close" then
					...
					ConfirmDialog.GroupTransparency = 1
					ConfirmFrame.Size = UDim2.new(0, 374, 0, 187)
					Tween(ConfirmOverlay, 0.25, { BackgroundTransparency = 0.6 })
					Tween(ConfirmFrame, 0.25, { Size = UDim2.new(0, 340, 0, 170) })
					Tween(ConfirmDialog, 0.25, { GroupTransparency = 0 })
